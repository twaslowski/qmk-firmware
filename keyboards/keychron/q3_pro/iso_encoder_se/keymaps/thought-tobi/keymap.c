...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [INTELLIJ] = LAYOUT_93_iso(
        ...
        _______,  _______,  _______,  _______,  _______,  LCMD(LALT(LSFT(KC_7))),  GIT_DIFF_REVISION,  GIT_DIFF_BRANCH,  _______,  _______,  _______,  INTELLIJ_REVEAL_IN_FINDER,  _______,              _______,                LCMD(LOPT(KC_TAB)),
